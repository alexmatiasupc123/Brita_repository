class mx.styles.CSSSetStyle
{
    ...
    static function classConstruct()
    {
        ...
        var _loc1 = mx.styles.CSSSetStyle.prototype;
        mx.styles.CSSStyleDeclaration.prototype.setStyle = _loc1._setStyle;
        _loc2.changeTextStyleInChildren = _loc1.changeTextStyleInChildren;
        _loc2.changeColorStyleInChildren = _loc1.changeColorStyleInChildren;
        _loc2.notifyStyleChangeInChildren = _loc1.notifyStyleChangeInChildren;
        _loc2.setStyle = _loc1.setStyle;
        var _loc3 = TextField.prototype;
        _loc3.setStyle = _loc2.setStyle;
        _loc3.changeTextStyleInChildren = _loc1.changeTextStyleInChildren;
        return (true);
    } // End of the function
