...
namespace Britanico.Web.DataAccess
{
    ...
    internal class uspMListarTodosBannerSelectionFactory : ISelectionFactory<NullableIdentity>
    {
        /// <summary>
        ...
        public uspMListarTodosBannerSelectionFactory()
        {
        }
        ...
        public DbCommand ConstructSelectCommand(Database db, NullableIdentity nullableIdentity)
        {
            ...
            DbCommand command = db.GetStoredProcCommand("dbo.uspMListarTodosBanner");
            return command;
        }
        #endregion
