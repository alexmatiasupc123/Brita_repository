...
namespace Britanico.Web.DataAccess
{
    ...
    internal class uspMListarTodosCategoraSelectionFactory : ISelectionFactory<NullableIdentity>
    {
        /// <summary>
        /// Creates the uspMListarTodosCategoraSelectionFactory to build a select statement for
        /// the given .
        /// </summary>
        /// <param name=""> to select from the database.</param>      
        public uspMListarTodosCategoraSelectionFactory()
        {
        }
        ...
        public DbCommand ConstructSelectCommand(Database db, NullableIdentity nullableIdentity)
        {
            ...
            DbCommand command = db.GetStoredProcCommand("dbo.uspMListarTodosCategora");
            return command;
        }
        #endregion
