...
namespace Britanico.Web.DataAccess
{
    ...
    /// </summary>
    internal class uspMListarTodosEventosXstrFechaSelectionFactory : ISelectionFactory<System.String>
    {
        /// <summary>
        ...
        public uspMListarTodosEventosXstrFechaSelectionFactory()
        {
        }

        #region ISelectionFactory<System.Datetime> Members
        public DbCommand ConstructSelectCommand(Database db, System.String fecha)
        {

            DbCommand command = db.GetStoredProcCommand("dbo.uspMListarTodosEventosXstrFecha");
