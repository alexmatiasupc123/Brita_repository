...
namespace Britanico.Web.DataAccess
{
    ...
    /// </summary>
    internal class uspMListarRegistroGaleriaSelectionFactory : ISelectionFactory<System.Int32>
    {
        /// <summary>
        /// Creates the uspMListarRegistroGaleriaSelectionFactory to build a select statement for
        /// the given System.Int32.
        /// </summary>
        /// <param name="System.Int32">System.Int32 to select from the database.</param>      
        public uspMListarRegistroGaleriaSelectionFactory()
        {
        }
        ...
        public DbCommand ConstructSelectCommand(Database db, System.Int32 gale_codi)
        {
            ...
            DbCommand command = db.GetStoredProcCommand("dbo.uspMListarRegistroGaleria");
