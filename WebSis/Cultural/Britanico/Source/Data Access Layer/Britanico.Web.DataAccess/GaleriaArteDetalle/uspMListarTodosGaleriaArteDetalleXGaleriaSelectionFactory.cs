...
namespace Britanico.Web.DataAccess
{
    ...
    /// </summary>
    internal class uspMListarTodosGaleriaArteDetalleXGaleriaSelectionFactory : ISelectionFactory<System.Int32>
    {
        /// <summary>
        ...
        public uspMListarTodosGaleriaArteDetalleXGaleriaSelectionFactory()
        {
        }
        ...
        public DbCommand ConstructSelectCommand(Database db, System.Int32 gale_codi)
        {
            ...
            DbCommand command = db.GetStoredProcCommand("dbo.uspMListarTodosGaleriaArteDetalleXGaleria");
