...
namespace Britanico.Web.DataAccess
{
    ...
    internal class uspMListarUltimoBoletinSelectionFactory : ISelectionFactory<NullableIdentity>
    {
        /// <summary>
        /// Creates the uspMListarUltimoBoletinSelectionFactory to build a select statement for
        /// the given .
        /// </summary>
        /// <param name=""> to select from the database.</param>      
        public uspMListarUltimoBoletinSelectionFactory()
        {
        }
        ...
        public DbCommand ConstructSelectCommand(Database db, NullableIdentity nullableIdentity)
        {
            ...
            DbCommand command = db.GetStoredProcCommand("dbo.uspMListarUltimoBoletin");
            return command;
        }
        #endregion
