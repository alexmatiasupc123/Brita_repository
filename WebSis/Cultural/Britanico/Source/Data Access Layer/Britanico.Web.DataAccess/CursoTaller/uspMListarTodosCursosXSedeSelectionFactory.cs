...
namespace Britanico.Web.DataAccess
{
    ...
    /// </summary>
    internal class uspMListarTodosCursosXSedeSelectionFactory : ISelectionFactory<System.Int32>
    {
        /// <summary>
        ...
        public uspMListarTodosCursosXSedeSelectionFactory()
        {
        }
        ...
        public DbCommand ConstructSelectCommand(Database db, System.Int32 sede)
        {
            ...
            DbCommand command = db.GetStoredProcCommand("dbo.uspMListarTodosCursosXSede");
