...
namespace Britanico.Web.DataAccess
{
    ...
    internal class uspMListarTodosCursoSelectionFactory : ISelectionFactory<NullableIdentity>
    {
        /// <summary>
        ...
        public uspMListarTodosCursoSelectionFactory()
        {
        }
        ...
        public DbCommand ConstructSelectCommand(Database db, NullableIdentity nullableIdentity)
        {
            ...
            DbCommand command = db.GetStoredProcCommand("dbo.uspMListarTodosCurso");
            return command;
        }
        #endregion
