...
namespace Britanico.Web.DataAccess
{
    ...
    internal class uspMListarTodosSedeSelectionFactory : ISelectionFactory<NullableIdentity>
    {
        /// <summary>
        ...
        public uspMListarTodosSedeSelectionFactory()
        {
        }
        ...
        public DbCommand ConstructSelectCommand(Database db, NullableIdentity nullableIdentity)
        {
            ...
            DbCommand command = db.GetStoredProcCommand("dbo.uspMListarTodosSede");
            return command;
        }
        #endregion
