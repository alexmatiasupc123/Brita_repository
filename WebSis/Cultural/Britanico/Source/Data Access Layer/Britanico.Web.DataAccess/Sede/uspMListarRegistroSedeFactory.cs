...
namespace Britanico.Web.DataAccess
{
    ...
    /// </summary>
    internal class uspMListarRegistroSedeFactory : IDomainObjectFactory<BESede>
    {
        public BESede Construct(IDataReader reader)
        {
            ...
            int sede_direIndex = reader.GetOrdinal("sede_dire");
            if (!reader.IsDBNull(sede_direIndex))
            {
                bESede.sede_dire = reader.GetString(sede_direIndex);
