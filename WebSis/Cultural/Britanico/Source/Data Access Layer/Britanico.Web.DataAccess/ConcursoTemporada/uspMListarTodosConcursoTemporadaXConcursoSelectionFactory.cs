...
namespace Britanico.Web.DataAccess
{
    ...
    /// </summary>
    internal class uspMListarTodosConcursoTemporadaXConcursoSelectionFactory : ISelectionFactory<System.Int32>
    {
        /// <summary>
        ...
        public uspMListarTodosConcursoTemporadaXConcursoSelectionFactory()
        {
        }
        ...
        public DbCommand ConstructSelectCommand(Database db, System.Int32 conc_codi)
        {
            ...
            DbCommand command = db.GetStoredProcCommand("dbo.uspMListarTodosConcursoTemporadaXConcurso");
