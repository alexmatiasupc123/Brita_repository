...
namespace Britanico.Web.DataAccess
{
    ...
    /// </summary>
    internal class uspMListarRegistroConcursoTemporadaXConcursoSelectionFactory : ISelectionFactory<System.Int32>
    {
        /// <summary>
        ...
        public uspMListarRegistroConcursoTemporadaXConcursoSelectionFactory()
        {
        }
        ...
        public DbCommand ConstructSelectCommand(Database db, System.Int32 conc_codi)
        {
            ...
            DbCommand command = db.GetStoredProcCommand("dbo.uspMListarRegistroConcursoTemporadaXConcurso");
