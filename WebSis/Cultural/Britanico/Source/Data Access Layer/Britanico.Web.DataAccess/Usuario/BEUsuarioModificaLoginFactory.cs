...
namespace Britanico.Web.DataAccess
{
    ...
    /// stored proc.
    /// </summary>
    internal class BEUsuarioModificaLoginFactory : IDbToBusinessEntityNameMapper, IUpdateFactory<BEUsuario>
    {
        /// <summary>
        /// Creates the BEUsuarioModificaLoginFactory to build an update statement for
        /// the given BEUsuario object.
        /// </summary>
        /// <param name="BEUsuario">BEUsuario to update into the database.</param>
        public BEUsuarioModificaLoginFactory()
        {
        }
        ...
        {
            DbCommand command = db.GetStoredProcCommand("dbo.uspMModificarLoginUsuario");
