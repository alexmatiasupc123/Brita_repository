...
namespace Britanico.Web.DataAccess
{
    ...
    internal class uspMListarTodosUsuarioSelectionFactory : ISelectionFactory<NullableIdentity>
    {
        /// <summary>
        /// Creates the uspMListarTodosUsuarioSelectionFactory to build a select statement for
        /// the given .
        /// </summary>
        /// <param name=""> to select from the database.</param>      
        public uspMListarTodosUsuarioSelectionFactory()
        {
        }
        ...
        public DbCommand ConstructSelectCommand(Database db, NullableIdentity nullableIdentity)
        {
            ...
            DbCommand command = db.GetStoredProcCommand("dbo.uspMListarTodosUsuario");
            return command;
        }
        #endregion
