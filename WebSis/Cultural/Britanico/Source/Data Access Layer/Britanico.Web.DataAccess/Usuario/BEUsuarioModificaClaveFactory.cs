...
namespace Britanico.Web.DataAccess
{
    ...
    /// stored proc.
    /// </summary>
    internal class BEUsuarioModificaClaveFactory : IDbToBusinessEntityNameMapper, IUpdateFactory<BEUsuario>
    {
        /// <summary>
        /// Creates the BEUsuarioModificaClaveFactory to build an update statement for
        /// the given BEUsuario object.
        /// </summary>
        /// <param name="BEUsuario">BEUsuario to update into the database.</param>
        public BEUsuarioModificaClaveFactory()
        {
        }
        ...
        {
            DbCommand command = db.GetStoredProcCommand("dbo.uspMModificarClaveUsuario");
