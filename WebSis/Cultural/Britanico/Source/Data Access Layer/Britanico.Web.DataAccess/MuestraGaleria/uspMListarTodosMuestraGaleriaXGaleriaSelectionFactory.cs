...
namespace Britanico.Web.DataAccess
{
    ...
    /// </summary>
    internal class uspMListarTodosMuestraGaleriaXGaleriaSelectionFactory : ISelectionFactory<System.Int32>
    {
        /// <summary>
        ...
        public uspMListarTodosMuestraGaleriaXGaleriaSelectionFactory()
        {
        }
        ...
        public DbCommand ConstructSelectCommand(Database db, System.Int32 gale_codi)
        {
            ...
            DbCommand command = db.GetStoredProcCommand("dbo.uspMListarTodosMuestraGaleriaXGaleria");
