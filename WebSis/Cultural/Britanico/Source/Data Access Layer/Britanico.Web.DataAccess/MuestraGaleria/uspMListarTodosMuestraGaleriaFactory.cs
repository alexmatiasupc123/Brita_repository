...
{
    /// <summary>
    /// Construct a BEMuestraGaleria object from a datareader.
    /// </summary>
    internal class uspMListarTodosMuestraGaleriaFactory : IDomainObjectFactory<BEMuestraGaleria>
    {
        public BEMuestraGaleria Construct(IDataReader reader)
        {
            ...
            int mues_anioIndex = reader.GetOrdinal("mues_anio");
            if (!reader.IsDBNull(mues_anioIndex))
            {
                bEMuestraGaleria.mues_anio = reader.GetInt32(mues_anioIndex);
