...
namespace Britanico.Web.DataAccess
{
    ...
    internal class uspMListarTodosConcursoSelectionFactory : ISelectionFactory<NullableIdentity>
    {
        /// <summary>
        /// Creates the uspMListarTodosConcursoSelectionFactory to build a select statement for
        /// the given .
        /// </summary>
        /// <param name=""> to select from the database.</param>      
        public uspMListarTodosConcursoSelectionFactory()
        {
        }
        ...
        public DbCommand ConstructSelectCommand(Database db, NullableIdentity nullableIdentity)
        {
            ...
            DbCommand command = db.GetStoredProcCommand("dbo.uspMListarTodosConcurso");
            return command;
        }
        #endregion
