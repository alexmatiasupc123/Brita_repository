<%@ Page Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="frm_historiaTeatro.aspx.cs" Inherits="Mantenimientos_frm_historiaTeatro" Title="CENTRO CULTURAL BRITANICO - ADMINISTRADOR DE CONTENIDOS" styleSheetTheme="SkinBritanico" ValidateRequest="false"%>
<%@ Register TagPrefix="FTB" Namespace="FreeTextBoxControls" Assembly="FreeTextBox" %>
<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="ajaxToolkit"%>

<asp:Content ID="Content1" ContentPlaceHolderID="cphPrincipal" Runat="Server">
    <asp:Label ID="Label1" runat="server" SkinID="lblTitulos" Text="HISTORIA DEL TEATRO BRITÁNICO"></asp:Label><br />
<BR />
<asp:Panel id="pNuevo" runat="server" Height="700px"  SkinID="paneles" Visible="True">
    <asp:HiddenField ID="hidCodigo" runat="server" />
    <asp:Label ID="lblNombreSeccion" runat="server" Text="Historia del Teatro" Width="400px"></asp:Label><br />
    <br />
