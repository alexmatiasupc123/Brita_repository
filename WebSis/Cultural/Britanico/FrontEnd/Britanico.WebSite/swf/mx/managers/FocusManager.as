class mx.managers.FocusManager extends mx.core.UIComponent
{
    ...
    function mouseActivate(Void)
    {
        ...
        _searchKey = getTimer();
        var _loc2 = this.getMousedComponentFromChildren(lastXMouse, lastYMouse, form);
