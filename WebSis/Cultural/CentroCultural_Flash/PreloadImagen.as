...
class PreloadImagen{
	...
	//constructor
	function PreloadImagen(queRuta:MovieClip, ancho:Number, alto:Number){
...
function onLoadProgress(clip:MovieClip, bytesLoaded:Number, bytesTotal:Number)
{
	...
	contenedor2.preload.gotoAndStop(porcentaje);
	contenedor2.preload.cargando.text = ""+porcentaje+" %";
}
