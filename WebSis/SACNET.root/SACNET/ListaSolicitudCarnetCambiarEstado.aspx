<%@ Page Title="" Language="C#" MasterPageFile="~/_MasterPage.master" AutoEventWireup="true"
    CodeFile="ListaSolicitudCarnetCambiarEstado.aspx.cs" Inherits="ListaSolicitudCarnetCambiarEstado" %>
                    ...
                    <fieldset>
                        ...
                        <table>
                            <tr>
                                ...
                                <td>
                                    <asp:Image ID="Image6" runat="server" ImageUrl="~/Comun/Imagenes/Icons/suceso.png" Height="18px" />
                                </td>
                                <td>
                                    <asp:Label ID="Label10" runat="server" Text="Cambiar estado a solicitud"></asp:Label>
                                </td>
                    ...
                    <fieldset style="width: 870px">
                        ...
                        <table>
                            ...
                            <tr>
                                ...
                                <td>
                                    <asp:TextBox ID="prm_sNombresUsuarioSAC" runat="server" onkeypress="return filterInput(0, event)"></asp:TextBox>
                                </td>
                            </tr>
                        </table>
                    </fieldset>
                        ...
                        <tr>
                            <td>
                                <asp:GridView ID="gvSolicitudesImpresionCarnet" runat="server" AllowPaging="True"
                                    ...
                                    EmptyDataText="No existen solicitudes registradas de carnés para entrega a usuario."  PageSize='<%# Util.ObtenerPaginacion() %>' 
                                    ...
                                    <Columns>
                                        ...
                                        <asp:BoundField DataField="sCodUsuarioSAC" HeaderText="Usuario SAC" Visible="false"
                                            HeaderStyle-Width="60px">
                                            <HeaderStyle Width="60px" />
                                        </asp:BoundField>
                                        ...
                                        <asp:TemplateField Visible="true">
                                            <ItemTemplate>
                                                <asp:ImageButton ID="btnVer" runat="server" CommandArgument='<%# Eval("sCodSolicitud") %>'
                                                    CommandName="Ver" ImageUrl="~/Comun/Imagenes/Icons/suceso.png" Height="18px" ToolTip="Cambiar de estado a la solicitud" />
                                            </ItemTemplate>
