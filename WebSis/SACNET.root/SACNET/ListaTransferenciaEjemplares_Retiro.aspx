<%@ Page Title="" Language="C#" MasterPageFile="~/_MasterPage.master" AutoEventWireup="true"
    CodeFile="ListaTransferenciaEjemplares_Retiro.aspx.cs" Inherits="ListaTransferenciaEjemplares_Retiro" %>
            ...
            <ContentTemplate>
                    ...
                    <fieldset>
                        ...
                        <table>
                            <tr>
                                ...
                                <td>
                                    <asp:Label ID="Label6" runat="server" Text="Ver ejemplares a retirar."></asp:Label>
                                </td>
                            </tr>
                        </table>
                    </fieldset>
                ...
                <div class="panelGria">
                    <asp:GridView Width="900px" ID="gvSolicitudTrasnferencia" runat="server" 
                        ...
                        EmptyDataText="No existen solicitudes de transferencia de retiro." 
                            ...
                            <asp:TemplateField>
                                <ItemTemplate>
                                    <asp:ImageButton ID="btnEditar" runat="server" CommandArgument='<%# Eval("sCodTransferencia") %>'
                                        ...
                                        ToolTip="Ver ejemplares a retirar" />
                                </ItemTemplate>
