...
public partial class Reporte_TitulosMayorRetraso : System.Web.UI.Page
{
    ...
    protected void ibtnAceptar_Click(object sender, ImageClickEventArgs e)
    {
        ...
        lista = oReportesLogic.TitulosMayorRetraso(CodSac, CodTipoMaterial, FechaInicio, FechaFin, orden);
        ReportDataSource rds = new ReportDataSource("Britanico_SacNet_BusinessEntities_Reportes", lista);

        rvTitulosMayorRetraso.LocalReport.DataSources.Clear();
        rvTitulosMayorRetraso.LocalReport.DataSources.Add(rds);
        rvTitulosMayorRetraso.LocalReport.ReportPath = @"Reportes\TitulosMayorRetraso.rdlc";
        ...
        rvTitulosMayorRetraso.LocalReport.SetParameters(Parametros);

        rvTitulosMayorRetraso.LocalReport.Refresh();
    }
    ...
    {
        RolesOpciones oRolesOpciones = this.Master.HelpOpcion_Permiso("Reporte_TitulosMayorRetraso.aspx");
