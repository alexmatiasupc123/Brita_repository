...
public partial class ListaSolicitudCarnetCambiarEstado : System.Web.UI.Page
{
    ...
    protected void gvSolicitudesImpresionCarnet_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        ...
        switch (e.CommandName)
        {
            ...
            case "Editar":
                ...
                break;
            case "Ver":
                querystringENCRYP = HelpEncrypt.Encriptar("id=" + codsCodSolicitud + "&nv=05" + "&ver=6" + ParametrosDelFiltro());
                Response.Redirect("MantSolicitudImpresionCarnet.aspx?pm=" + querystringENCRYP );
                break;
            default:
                break;
    ...
    protected void gvSolicitudesImpresionCarnet_RowDataBound(object sender, GridViewRowEventArgs e)
    {
        if (e.Row.RowType == DataControlRowType.DataRow)
        {
            ...
            ((ImageButton)e.Row.Cells[13].FindControl("btnVer")).Visible = true;
        }
    }
    ...
    private void CargarPagina()
    {
        ...
        prm_sCodArguEstado1.SelectedValue = " ";
    ...
    {
        //RolesOpciones oRolesOpciones = this.Master.HelpOpcion_Permiso("ListaSolicitudCarnetCambiarEstado.aspx");
        List<RolesOpciones> lstRolesOpciones = this.Master.HelpOpcion_Permiso_Lista("ListaSolicitudCarnetCambiarEstado.aspx");//ELVP:11-10-2011
