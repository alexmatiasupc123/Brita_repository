<%@ Page Title="" Language="C#" MasterPageFile="~/_MasterPage.master" AutoEventWireup="true"
    CodeFile="ListaSolicitudCarnetRecibidoSAC.aspx.cs" Inherits="ListaSolicitudCarnetRecibidoSAC" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cphTitulo" runat="Server">
    <asp:Literal ID="lblTituloPagina" runat="server" Text="Lista de Recepción de Carnés impresos"></asp:Literal>
</asp:Content>
                        ...
                        <tr>
                            <td>
                                <asp:GridView ID="gvSolicitudesImpresionCarnet" runat="server" AllowPaging="True"
                                    ...
                                    DataKeyNames="sCodSolicitud,sCodArguEstado,sCodUsuarioSAC" EmptyDataText="No existen solicitudes de carnés impresos para recepcionar en el SAC."
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="FOTO" HeaderStyle-Width="40px" ItemStyle-HorizontalAlign="Center">
                                            <ItemTemplate>
                                        ...
                                        <asp:TemplateField HeaderText="NUEVO/ DUPLIC." ItemStyle-Width="55px" ItemStyle-HorizontalAlign="Center">
                                            <ItemTemplate>
