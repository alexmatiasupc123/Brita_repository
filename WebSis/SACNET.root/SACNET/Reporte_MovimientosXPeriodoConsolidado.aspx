<%@ Page Title="" Language="C#" MasterPageFile="~/_MasterPage.master" AutoEventWireup="true"
    CodeFile="Reporte_MovimientosXPeriodoConsolidado.aspx.cs" Inherits="Reporte_MovimientosXPeriodoConsolidado" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div style="width: 800px">
            ...
            <fieldset style="width: 770px">
                ...
                <table width="770px">
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:Label ID="Label4" runat="server" Text="Tipo Reporte :"></asp:Label>
                        </td>
                        <td>
                            <asp:DropDownList ID="ddlTipoReporte" runat="server">
                                <asp:ListItem Value="L">Listado</asp:ListItem>
                                <asp:ListItem Value="G">Grafico</asp:ListItem>
                            </asp:DropDownList>
                        </td>
                    </tr>
                </table>
        ...
        <div class="panelGria">
            <rsweb:ReportViewer ID="rvRankingTitulos" runat="server" Width="770px" HHeight="300mm"
